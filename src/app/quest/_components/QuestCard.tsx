...
export default function QuestCard({ quest }: QuestCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl p-3 shadow-md hover:shadow-lg transition-shadow border border-gray-100">
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1 min-w-0">
          ...
          <span className="text-xs text-gray-500 block">{category?.name}</span>
        </div>
      </div>
